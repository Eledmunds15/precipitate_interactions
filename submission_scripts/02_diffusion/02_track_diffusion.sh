...
#SBATCH --output=slurm_shear/diff-tracking-%A_%a.out
#SBATCH --array=0-2
...
INPUT_FILES=("test_diffusion_T800_ST150_R20_N1234" "test_diffusion_T800_ST100_R30_N1234" "test_diffusion_T700_ST150_R30_N1234")
...
srun --export=ALL python dislo_tracking/02_track_diffusion.py \
